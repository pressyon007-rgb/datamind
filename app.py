...
with tabs[6]:
    st.markdown(
        '<div class="section-title">🤖 Ask Data Analytics</div>',
        unsafe_allow_html=True
    )
    st.write(
        "Ask natural-language questions about your dataset. "
        "The system evaluates the data directly and provides data-driven answers."
    )
    st.divider()
        ...
        if query and query != "-- Select a question --":
            with st.spinner("Analyzing data..."):
                ...
                if answer_result:
                    ...
                    # Fallback to AI Analyst / General response
...
with tabs[7]:
    ...
    st.write(
        ...
        "summarizing your dataset, analysis, research, and recommendations."
    )
    st.divider()
